    ...
    <div class="span4">
        ...
        <div class="row">
            <div class="span4" id="primary-img">
                ...
                if (!empty($product->images[0])) {
                    ...
                    $photo = '<img class="responsiveImage" src="' . $primary->filename . '" alt="' . $product->seo_title . '"/>';
                }
                echo $photo
                ?>
            </div>
        ...
        <?php if (count($product->images) > 1): ?>
            ...
            <!--				<img class="span1" onclick="$(this).squard('390', $('#primary-img'));" src="<?php echo base_url('uploads/images/medium/' . $image->filename); ?>"/>-->
                        <img class="span1" onclick="$(this).squard('390', $('#primary-img'));" src="<?php echo $image->filename; ?>"/>
                    <?php endforeach; ?>
                </div>
            </div>
        <?php endif; ?>
            ...
            <div class="span8">
                <div class="page-header">
                    <h2 style="font-weight:normal">
                        ...
                        <?php if($tao_parameters){ ?>
                        <div style="border: 1px solid red; margin-top: 20px">
                            <h1>Описание товара</h1>
                            <table>
                                <?php foreach ($tao_parameters as $tao_p) { ?>
                                    <tr>
                                        <td><?php echo $tao_p['name']; ?></td>
                                        <td>
                                            <?php foreach($tao_p['values'] as $tao_v){ 
                                                echo $tao_v."<br>";
                                            }
                                            ?>
                                        </td>
                                        ...
                                        <div class="controls">
                                            ...
                                            foreach ($option->values as $values):
                                                ...
                                                <label class="radio">
                                                    ...
                                                    <?php echo $option->name; ?> <?php echo($values->price != 0) ? '(' . format_currency($values->price) . ') ' : '';
                                    echo $values->name;
                                                    ?>
                                                </label>
                                            <?php endforeach; ?>
