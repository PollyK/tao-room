...
<?php if (!empty($base_url) && is_array($base_url)): ?>
                            ...
                            foreach ($base_url as $bc):
                                ...
                                if ($count == count($base_url)):
                                    ?>
                                                <li class="active"><?php echo $slugs_array[$bc]; ?></li>
                                            <?php else: ?>
                                                <li><a href="<?php echo site_url($url_path); ?>"><?php echo $slugs_array[$bc]; ?></a></li> <span class="divider">/</span>
                                            <?php
                                            endif;
                                            $count++;
                                        endforeach;
